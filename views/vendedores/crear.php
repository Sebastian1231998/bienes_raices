...
<form class="formulario" method="POST" enctype="multipart/form-data">
  ...
  <?php include __DIR__ . '/../../includes/templates/formulario_vendedor.php'  ?> 
   ...
   <div style="text-align:right">
      <input type="submit" value="Crear Vendedor" style="padding: 2rem 3rem; width:15%; background-color: #a1dc39; color: white; font-weight: bold; border: none;cursor:pointer">
   </div>
</form>
